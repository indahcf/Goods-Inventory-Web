            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <form action="<?= base_url('user/edit/'.$user->id) ?>" method="POST" novalidate>
                            <div class="card-body">
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label" for="name">Nama</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="name" id="name" class="form-control <?= form_error('name') ? 'is-invalid' : ''; ?>" value="<?= set_value('name', $user->name); ?>" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="email" name="email" id="email" class="form-control <?= form_error('email') ? 'is-invalid' : ''; ?>" value="<?= set_value('email', $user->email); ?>" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control <?= form_error('role') ? 'is-invalid' : ''; ?>" name="role" id="role" required>
                                            ...
                                            <option value="pegawai" <?= set_value('role', $user->role) == 'pegawai'  ? 'selected' : '' ?>>Pegawai</option>
                                        </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <small class="pt-1 d-block">*Kosongkan bila tidak ingin mengubah</small>
