            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <form action="<?= base_url('item/create') ?>" method="POST" novalidate>
                            <div class="card-body">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control select2 <?= form_error('unit_id') ? 'is-invalid' : ''; ?>" name="unit_id" id="unit" required>
                                            ...
                                            <?php foreach ($units as $unit) : ?>
                                                <option value="<?= $unit->id ?>" <?= set_value('unit_id') == $unit->id ? 'selected' : '' ?>><?= $unit->name ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group">
                                            ...
                                            <input type="number" name="price" id="price" class="form-control <?= form_error('price') ? 'is-invalid' : ''; ?>" value="<?= set_value('price'); ?>" required>
                                        </div>
                                ...
                                <div class=" form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" name="stock" id="stock" class="form-control <?= form_error('stock') ? 'is-invalid' : ''; ?>" value="<?= set_value('stock'); ?>" required>
